...
let MasterController = class MasterController {
    ...
    async getColleges(universityId) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get list of universities' }),
