...
__decorate([
    (0, common_1.Get)('download-apk'),
    (0, swagger_1.ApiOperation)({ summary: 'Download latest MyVault release APK' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Backend root status check' }),
    __metadata("design:type", Function),
