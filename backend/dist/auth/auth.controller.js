...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login student with credentials' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email, mobile or hall ticket already registered' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Direct password reset for registered accounts' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get current authenticated student profile' }),
