...
try {
  ...
  // Seed may fail in production if data already exists or due to PgBouncer
  // prepared-statement conflicts. This is non-fatal — the server can still start.
...
try {
  ...
  // Policies may already be applied — non-fatal
