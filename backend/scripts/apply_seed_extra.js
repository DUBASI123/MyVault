...
async function main() {
  ...
  try {
    const sqlFilePath = path.join(__dirname, 'seed_extra_courses.sql');
    console.log(`Reading SQL file from: ${sqlFilePath}`);
    const sqlContent = fs.readFileSync(sqlFilePath, 'utf8');

    console.log("Seeding extra 10 courses into database...");
    ...
    console.log("🎉 Extra 10 courses seeded successfully!");
  } catch (error) {
