    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('File uploaded successfully to Supabase Storage!'),
  ...
  Future<void> _confirmDelete(UploadedFileModel item) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to delete "${item.title}"? This will remove it from Supabase Storage and the database.',
